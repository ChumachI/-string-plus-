...
START_TEST(test_my_memchr_fn) {
  const char *s = "hello world";
  char *result = my_memchr(s, 'w', strlen(s));
  ck_assert_ptr_eq(result, s + 6);
}
END_TEST

START_TEST(test_my_memchr_fn_null) {
  const char *s = "hello world";
  char *result = my_memchr(s, 'z', strlen(s));
  ck_assert_ptr_eq(result, NULL);
}
END_TEST

START_TEST(test_my_memchr_fn_compare) {
  const char *s = "hello world";
  char *result_my = my_memchr(s, 'o', strlen(s));
  char *result_str = memchr(s, 'o', strlen(s));
  ck_assert_ptr_eq(result_my, result_str);
}
END_TEST
...
START_TEST(test_different_lengths) {
  ...
  char str2[] = "Hello";
  ck_assert_int_eq(my_memcmp(str1, str2, strlen(str2)),
...
START_TEST(test_same_strings) {
  ...
  ck_assert_int_eq(my_memcmp(str1, str2, strlen(str1)),
...
START_TEST(test_different_strings_negative) {
  ...
  ck_assert(my_memcmp(str1, str2, strlen(str1)) *
                memcmp(str1, str2, strlen(str1)) >=
            0);
}
END_TEST
...
START_TEST(test_my_memcpy_basic) {
  char src[6] = "Hello";
  char dest[6];
  char dest_orig[6];
...
START_TEST(test_my_memcpy_non_overlap) {
...
START_TEST(test_my_memcpy_zero_size) {
  char src[6] = "Hello";
  char dest[6] = "World";
...
START_TEST(test_my_memcpy_large_size) {
  char src[1024];
  char dest[1024];
  char dest_orig[1024];
...
START_TEST(test_my_memset_normal_case) {
  char str1[10] = "test";
  char str2[10] = "test";
...
START_TEST(test_my_memset_zero_length) {
  char str1[10] = "test";
  char str2[10] = "test";
...
START_TEST(test_my_memset_full_length) {
  char str1[10] = "test";
  char str2[10] = "test";

  my_memset(str1, 'a', sizeof(str1));
...
START_TEST(test_my_memset_null_pointer) {
  void *str1 = my_NULL;
  void *str2 = my_NULL;

  ck_assert_ptr_eq(my_memset(str1, 'a', 5), str2);
}
END_TEST

// TEST STRNCAT

START_TEST(test_my_strncat_normal_case) {
  char dest1[20] = "Hello";
  char dest2[20] = "Hello";
...
START_TEST(test_my_strncat_less_than_n) {
  char dest1[25] = "Hello";
  char dest2[25] = "Hello";
  const char *src = " world!";

  my_strncat(dest1, src, 20);
...
START_TEST(test_my_strncat_zero_length) {
  char dest1[20] = "Hello";
  char dest2[20] = "Hello";
  const char *src = " world!";

  my_strncat(dest1, src, 0);
  strncat(dest2, src, 0);
...
START_TEST(test_my_strncat_null_dest) {
  char *dest1 = my_NULL;
  char *dest2 = my_NULL;
  const char *src = " world!";

  ck_assert_ptr_eq(my_strncat(dest1, src, 5), dest2);
}
END_TEST

// TEST STRCHR

START_TEST(test_my_strchr_found) {
  const char *str = "Hello, world!";
  char c = 'w';

  char *result1 = my_strchr(str, c);
...
START_TEST(test_my_strchr_not_found) {
  const char *str = "Hello, world!";
  char c = 'x';
...
START_TEST(test_my_strchr_null_termination) {
  const char *str = "Hello, world!";
  char c = '\0';
...
START_TEST(test_my_strchr_null_string) {
  const char *str = my_NULL;
  char c = 'H';

  char *result1 = my_strchr(str, c);

  ck_assert_ptr_eq(result1, my_NULL);
}
END_TEST

// TEST STRNCMP

START_TEST(test_my_strncmp_equal_strings) {
  const char *str1 = "Hello, world!";
  const char *str2 = "Hello, world!";

  int result1 = my_strncmp(str1, str2, 8);
...
START_TEST(test_my_strncmp_unequal_strings) {
  const char *str1 = "Hello, world!";
...
START_TEST(test_my_strncmp_empty_strings) {
  const char *str1 = "";
  const char *str2 = "";
...
START_TEST(test_my_strncmp_zero_n) {
  const char *str1 = "Hello, world!";
  const char *str2 = "Hello, Universe!";
  int result1 = my_strncmp(str1, str2, 0);
...
START_TEST(test_my_strncpy_non_empty_string) {
  const char *src = "Hello, world!";
  char dest1[20];
  char dest2[20];

  char *result1 = my_strncpy(dest1, src, 8);
...
START_TEST(test_my_strncpy_full_copy) {
  const char *src = "Hello, world!";
  char dest1[20];
  char dest2[20];

  char *result1 = my_strncpy(dest1, src, 13);
...
START_TEST(test_my_strncpy_empty_string) {
  const char *src = "";
  char dest1[20];
  char dest2[20];
  char *result1 = my_strncpy(dest1, src, 10);
...
START_TEST(test_my_strcspn_no_matching_chars) {
  const char *str1 = "abcdef";
  const char *str2 = "ghijkl";
  my_size_t result1 = my_strcspn(str1, str2);
  size_t result2 = strcspn(str1, str2);
  ck_assert_uint_eq(result1, result2);
}
END_TEST

START_TEST(test_my_strcspn_some_matching_chars) {
...
START_TEST(test_my_strlen_empty_string) {
  const char *str = "";
  my_size_t result1 = my_strlen(str);
  my_size_t result2 = strlen(str);
  ck_assert_int_eq(result1, result2);
}
END_TEST

START_TEST(test_my_strlen_nonempty_string) {
  const char *str = "Hello, world!";
  my_size_t result1 = my_strlen(str);
  my_size_t result2 = strlen(str);
  ck_assert_int_eq(result1, result2);
...
START_TEST(test_my_strpbrk_found) {
  const char *str1 = "Hello, World!";
  const char *str2 = "World";
  char *expected = strpbrk(str1, str2);
  char *result = my_strpbrk(str1, str2);
  ck_assert_ptr_eq(result, expected);
}
END_TEST

START_TEST(test_my_strpbrk_not_found) {
  const char *str1 = "Hello, World!";
  const char *str2 = "xyz";
  char *expected = strpbrk(str1, str2);
  char *result = my_strpbrk(str1, str2);
...
START_TEST(test_my_strpbrk_null_str1) {
  const char *str1 = my_NULL;
  const char *str2 = "World";
  char *result = my_strpbrk(str1, str2);
  ck_assert_ptr_eq(result, my_NULL);
}
END_TEST

// TEST STRRCHR

START_TEST(test_my_strrchr_found) {
...
START_TEST(test_my_strrchr_not_found) {
  const char *str = "Hello, World! This is a test.";
  int c = 'z';
  char *expected = strrchr(str, c);
  char *result = my_strrchr(str, c);
...
START_TEST(test_my_strrchr_null_str) {
  const char *str = my_NULL;
  int c = 't';
  char *result = my_strrchr(str, c);
  ck_assert_ptr_eq(result, my_NULL);
...
START_TEST(test_my_strstr_full_match) {
  const char *haystack = "Hello, World!";
...
START_TEST(test_my_strstr_partial_match) {
  const char *haystack = "Hello, World!";
...
START_TEST(test_my_strtok_basic) {
  char input[] = "Hello, world! This is an example.";
  char input_orig[] = "Hello, world! This is an example.";
  char delim[] = " ,!";

  char *token_my = my_strtok(input, delim);
  char *token_orig = strtok(input_orig, delim);

  while (token_my != my_NULL && token_orig != NULL) {
    ck_assert_msg(strcmp(token_my, token_orig) == 0,
                  "Token mismatch: my_strtok got '%s', strtok got '%s'",
                  token_my, token_orig);
    token_my = my_strtok(my_NULL, delim);
    token_orig = strtok(NULL, delim);
  }

  ck_assert(token_my == my_NULL && token_orig == NULL);
}
END_TEST

// TEST STRSPN

START_TEST(test_my_strspn_matching) {
  const char *str1 = "Hello, World!";
  const char *str2 = "Hel";
  my_size_t expected = strspn(str1, str2);
  size_t result = my_strspn(str1, str2);
  ck_assert_uint_eq(result, expected);
}
END_TEST

START_TEST(test_my_strspn_no_matching) {
  const char *str1 = "Hello, World!";
  const char *str2 = "XYZ";
  my_size_t expected = strspn(str1, str2);
  my_size_t result = my_strspn(str1, str2);
  ck_assert_uint_eq(result, expected);
}
END_TEST

START_TEST(test_my_strspn_null_str1) {
  const char *str1 = my_NULL;
  const char *str2 = "Hel";
  my_size_t result = my_strspn(str1, str2);
...
START_TEST(test_my_strcpy_non_empty_string) {
  const char *src = "Hello, world!";
  char dest1[20];
  char dest2[20];

  char *result1 = my_strcpy(dest1, src);
...
START_TEST(test_my_strcpy_empty_string) {
  const char *src = "";
  char dest1[20];
  char dest2[20];
...
START_TEST(test_my_memmove_non_overlap) {
...
START_TEST(test_my_memmove_overlap_forward) {
  char data[] = "Hello, world!";
  char data_orig[] = "Hello, world!";

  my_memmove(data + 1, data, 11);
  memmove(data_orig + 1, data_orig, 11);
  ck_assert_str_eq(data, data_orig);
}
END_TEST

START_TEST(test_my_memmove_overlap_backward) {
  char data[] = "Hello, world!";
  char data_orig[] = "Hello, world!";

  my_memmove(data, data + 1, 11);
  memmove(data_orig, data_orig + 1, 11);
  ck_assert_str_eq(data, data_orig);
}
END_TEST

START_TEST(test_my_memmove_zero_size) {
  char data[] = "Hello, world!";
  char data_orig[] = "Hello, world!";
  char *result;
  char *result_orig;

  result = my_memmove(data, data, 0);
...
START_TEST(test_base) {
  ...
  my_sprintf(data, "hello %10c %c  ", w, c);
  ...
  wint_t ch = L'あ';
  wint_t ru = L'ф';
  my_sprintf(data, "%lc", ch);
  sprintf(data_orig, "%lc", ch);
  ck_assert_str_eq(data, data_orig);

  my_sprintf(data, "%lc", ru);
...
START_TEST(test_int_d_variations) {
  ...
  my_sprintf(data, "Number: %d", num);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "Number: %10d", num);
  my_sprintf(data, "Number: %10d", num);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "Number: %0d", num);
  my_sprintf(data, "Number: %0d", num);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "Number: %ld", num_long);
  my_sprintf(data, "Number: %ld", num_long);
  ck_assert_str_eq(data, data_orig);
  ...
  my_sprintf(data, "Number: %03ld", num_long);
  ck_assert_str_eq(data, data_orig);
  ...
  my_sprintf(data, "Number: %08d", num);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "Number: %-+8d", num);
  my_sprintf(data, "Number: %-+8d", num);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "Number: %08d, same number: %08i", num, num);
  my_sprintf(data, "Number: %08d, same number: %08i", num, num);
  ck_assert_str_eq(data, data_orig);
  ...
  my_sprintf(data, "Number: %- 8d, same number: %- 8i", num, num);
  ck_assert_str_eq(data, data_orig);
}
END_TEST
...
START_TEST(test_string_variation) {
  ...
  my_sprintf(data, "Number: %s", str);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "The string is '%.5s'", str);
  my_sprintf(data, "The string is '%.5s'", str);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "The string is '%20s'", str);
  my_sprintf(data, "The string is '%20s'", str);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "The percent symbol is %% %%");
  my_sprintf(data, "The percent symbol is %% %%");
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "String: %ls", wide_str);
  my_sprintf(data, "String: %ls", wide_str);
  ck_assert_str_eq(data, data_orig);
}
END_TEST
...
START_TEST(test_float) {
  ...
  my_sprintf(data, "%.8f", 1111123.11233444);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "%f", 12311.11233444);
  my_sprintf(data, "%f", 12311.11233444);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "%20f", 11.112);
  my_sprintf(data, "%20f", 11.112);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "%.2f", q);
  my_sprintf(data, "%.2f", q);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "%10.2f", q);
  my_sprintf(data, "%10.2f", q);
  ck_assert_str_eq(data, data_orig);
  ...
  my_sprintf(data, "%#5f", q);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "%-+8.3f", q);
  my_sprintf(data, "%-+8.3f", q);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "%.*f", 2, q);
  my_sprintf(data, "%.*f", 2, q);
  ck_assert_str_eq(data, data_orig);
  ...
  my_sprintf(data, "%lf", 123.11);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "%.15lf", 123.11);
  my_sprintf(data, "%.15lf", 123.11);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "%Lf", ld_value);
  my_sprintf(data, "%Lf", ld_value);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "%.15Lf", ld_value);
  my_sprintf(data, "%.15Lf", ld_value);
  ck_assert_str_eq(data, data_orig);
}
END_TEST
...
START_TEST(test_uint_basic) {
  ...
  my_sprintf(data, "Number: %u", num);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "Number: %lu", num_long);
  my_sprintf(data, "Number: %lu", num_long);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "Number: %hu", num_short);
  my_sprintf(data, "Number: %hu", num_short);
  ck_assert_str_eq(data, data_orig);

  sprintf(data_orig, "Number: %03lu", num_long);
  my_sprintf(data, "Number: %03lu", num_long);
  ck_assert_str_eq(data, data_orig);
}
END_TEST
...
START_TEST(test_uint_large) {
  ...
  my_sprintf(data, "Large number: %u", num);
  ck_assert_str_eq(data, data_orig);
}
END_TEST
...
START_TEST(test_uint_width) {
  ...
  my_sprintf(data, "Padded number: %10u", num);
  ck_assert_str_eq(data, data_orig);
  sprintf(data_orig, "Padded number: %-10u", num);
  my_sprintf(data, "Padded number: %-10u", num);
  ck_assert_str_eq(data, data_orig);
...
START_TEST(test_uint_zero_padding) {
  ...
  my_sprintf(data, "Zero-padded number: %010u", num);
  ck_assert_str_eq(data, data_orig);
}
...
START_TEST(test_e_and_E) {
  ...
  my_sprintf(data, "%.3e", value);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%10e", value);
  my_sprintf(data, "%10e", value);
  ck_assert_str_eq(data_orig, data);
  ...
  my_sprintf(data, "%-.*e", -20, value_2);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%-10e", value_2);
  my_sprintf(data, "%-10e", value_2);
  ck_assert_str_eq(data_orig, data);
}
END_TEST
...
START_TEST(test_g_and_G_formatting) {
  ...
  my_sprintf(data, "%g", 0.0123);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%0g", 0.0123);
  my_sprintf(data, "%0g", 0.0123);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%g", 1234531.2120300);
  my_sprintf(data, "%g", 1234531.21203000);
  ck_assert_str_eq(data_orig, data);
  ...
  my_sprintf(data, "%#g", 1234531.2120);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%.2g", 123456.022);
  my_sprintf(data, "%.2g", 123456.022);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%#g", 12345678.121110);
  my_sprintf(data, "%#g", 12345678.121110);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%#g", 123456.1211101);
  my_sprintf(data, "%#g", 123456.1211101);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%.2g", 123456.0);
  my_sprintf(data, "%.2g", 123456.0);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%10g", 12345.1);
  my_sprintf(data, "%10g", 12345.1);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%10g", 1.12365789);
  my_sprintf(data, "%10g", 1.12365789);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%30g", 123456.123);
  my_sprintf(data, "%30g", 123456.123);
  ck_assert_str_eq(data_orig, data);
}
END_TEST
...
START_TEST(test_hex_formatting) {
  ...
  my_sprintf(data, "%x", value);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%lx", value_long);
  my_sprintf(data, "%lx", value_long);
  ck_assert_str_eq(data_orig, data);
...
START_TEST(test_o) {
  ...
  my_sprintf(data, "%o", value);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%-10o", value);
  my_sprintf(data, "%-10o", value);
  ck_assert_str_eq(data_orig, data);
...
START_TEST(test_p) {
  ...
  my_sprintf(data, "%p", ptr);
  ck_assert_str_eq(data_orig, data);

  sprintf(data_orig, "%15p", ptr);
  my_sprintf(data, "%15p", ptr);
  ck_assert_str_eq(data_orig, data);
...
START_TEST(test_n) {
  ...
  my_sprintf(data, "Hello, %s! This is number %dn%n", "world", 42, &n2);

  ck_assert_str_eq(data_orig, data);
  ck_assert_int_eq(n1, n2);

  sprintf(data_orig, "%10s%nhello", "world", &n1);
  my_sprintf(data, "%10s%nhello", "world", &n2);
  ...
  my_sprintf(data, "%.5s%nhello", "world", &n2);
...
START_TEST(test_i_v19) {
  ...
  char e, f;
  int result1, result2;
  result1 = my_sscanf(str, "%i%d%c", &a, &c, &e);
...
START_TEST(test_s_v1) {
  ...
  char a[20], b[20];
  int result1, result2;
  result1 = my_sscanf(str, "%*d%19s%*d", a);
...
START_TEST(test_s_v4) {
  ...
  char a[20], b[20];
  int result1, result2;
  result1 = my_sscanf(str, "%*s%19s%*s", a);
...
START_TEST(test_s_v5) {
  ...
  wchar_t wstr2[100];
  int result1, result2;
  result1 = my_sscanf(str, "My message: %99ls", wstr1);
...
START_TEST(test_n_v4) {
  ...
  char str2[100];
  int result1, result2;
  result1 = my_sscanf(str, "%99s%n", str1, &a);
...
START_TEST(test_n_v3) {
  ...
  int result1, result2;
  result1 = my_sscanf(str, "%19s%19s%19s%n", s1, s3, s5, &a);
...
START_TEST(test_s_v6) {
  ...
  wchar_t wstr2[100];
  int result1, result2;
  result1 = my_sscanf(str, "My message: %3ls", wstr1);
...
START_TEST(test_f_v10) {
  ...
  long double a, b, c, d;
  int result1, result2;
  result1 = my_sscanf(str, "%Lg%Lf", &a, &c);
...
START_TEST(test_f_v11) {
  ...
  double a, b, c, d;
  int result1, result2;
  result1 = my_sscanf(str, "%le%lf", &a, &c);
...
START_TEST(test_combo_v2) {
  ...
  char e[20], f[20];
  int result1, result2;
  result1 = my_sscanf(data, "%d %f %s", &a, &c, e);
  result2 = my_sscanf(data, "%d %f %s", &b, &d, f);
  ck_assert_int_eq(result1, result2);
  ck_assert_int_eq(a, b);
  ck_assert_double_eq(c, d);
...
START_TEST(test_combo_v3) {
  ...
  int a2, b2, c2;
  int result1, result2;
  result1 = my_sscanf(data, "%x %x %x", &a1, &b1, &c1);
  result2 = my_sscanf(data, "%x %x %x", &a2, &b2, &c2);
  ck_assert_int_eq(result1, result2);
...
START_TEST(test_combo_v4) {
  ...
  float a2, b2, c2;
  int result1, result2;
  result1 = my_sscanf(data, "%f %e %g", &a1, &b1, &c1);
  result2 = my_sscanf(data, "%f %e %g", &a2, &b2, &c2);
  ck_assert_int_eq(result1, result2);
...
START_TEST(test_combo_v5) {
  ...
  char a2, b2[20], c2;
  int result1, result2;
  result1 = my_sscanf(data, "%c %s %c", &a1, b1, &c1);
  result2 = my_sscanf(data, "%c %s %c", &a2, b2, &c2);
  ck_assert_int_eq(result1, result2);
  ck_assert_int_eq(a1, a2);
...
START_TEST(test_my_to_upper_null) {
  const char *str1 = NULL;
  char *result = my_to_upper(str1);
  ck_assert_ptr_null(result);
}
END_TEST

START_TEST(test_my_to_upper_v1) {
  const char *str1 = "big";
  char *result = my_to_upper(str1);
...
START_TEST(test_my_to_upper_v2) {
...
START_TEST(test_my_to_upper_v3) {
  const char *str1 = "BIg";
  char *result = my_to_upper(str1);
  ck_assert_str_eq(result, "BIG");
  free(result);
...
START_TEST(test_my_to_lower_null) {
  const char *str1 = NULL;
  char *result = my_to_lower(str1);
  ck_assert_ptr_null(result);
}
END_TEST

START_TEST(test_my_to_lower_v1) {
...
START_TEST(test_my_to_lower_v2) {
...
START_TEST(test_my_to_lower_v3) {
  const char *str1 = "BIg";
  char *result = my_to_lower(str1);
  ck_assert_str_eq(result, "big");
  free(result);
...
START_TEST(test_my_insert_null_null) {
  const char *str1 = NULL;
  const char *str2 = NULL;
  char *result = my_insert(str1, str2, 0);
  ck_assert_ptr_null(result);
}
END_TEST

START_TEST(test_my_insert_v1) {
  const char *str1 = "insert><here";
  const char *str2 = "right";
  char *result = my_insert(str1, str2, 7);
  ck_assert_str_eq(result, "insert>right<here");
  free(result);
}
END_TEST

START_TEST(test_my_insert_v2_out_of_range) {
  const char *str1 = "insert><here";
  const char *str2 = "right";
  char *result = my_insert(str1, str2, 20);
  ck_assert_ptr_null(result);
}
END_TEST

START_TEST(test_my_insert_v3_out_of_range) {
  const char *str1 = "insert><here";
  const char *str2 = "right";
  char *result = my_insert(str1, str2, -1);
  ck_assert_ptr_null(result);
}
END_TEST

START_TEST(test_my_trim_v1) {
  const char *str1 = "not_okey";
  const char *str2 = "not";
  char *result = my_trim(str1, str2);
  ck_assert_str_eq(result, "_okey");
  free(result);
}
END_TEST

START_TEST(test_my_trim_v2) {
  const char *str1 = "not_okey";
  const char *str2 = "otn";
  char *result = my_trim(str1, str2);
  ck_assert_str_eq(result, "_okey");
...
Suite *my_string_suite(void) {
  ...
  tcase_add_test(tc_core, test_my_memchr_fn);
  tcase_add_test(tc_core, test_my_memchr_fn_null);
  tcase_add_test(tc_core, test_my_memchr_fn_compare);
  ...
  tcase_add_test(tc_core, test_my_memcpy_basic);
  tcase_add_test(tc_core, test_my_memcpy_non_overlap);
  tcase_add_test(tc_core, test_my_memcpy_zero_size);
  tcase_add_test(tc_core, test_my_memcpy_large_size);

  tcase_add_test(tc_core, test_my_memset_normal_case);
  tcase_add_test(tc_core, test_my_memset_zero_length);
  tcase_add_test(tc_core, test_my_memset_full_length);
  tcase_add_test(tc_core, test_my_memset_null_pointer);

  tcase_add_test(tc_core, test_my_strncat_normal_case);
  tcase_add_test(tc_core, test_my_strncat_less_than_n);
  tcase_add_test(tc_core, test_my_strncat_zero_length);
  tcase_add_test(tc_core, test_my_strncat_null_dest);

  tcase_add_test(tc_core, test_my_strchr_found);
  tcase_add_test(tc_core, test_my_strchr_not_found);
  tcase_add_test(tc_core, test_my_strchr_null_termination);
  tcase_add_test(tc_core, test_my_strchr_null_string);

  tcase_add_test(tc_core, test_my_strncmp_equal_strings);
  tcase_add_test(tc_core, test_my_strncmp_unequal_strings);
  tcase_add_test(tc_core, test_my_strncmp_empty_strings);
  tcase_add_test(tc_core, test_my_strncmp_zero_n);

  tcase_add_test(tc_core, test_my_strncpy_non_empty_string);
  tcase_add_test(tc_core, test_my_strncpy_full_copy);
  tcase_add_test(tc_core, test_my_strncpy_empty_string);

  tcase_add_test(tc_core, test_my_strcspn_no_matching_chars);
  tcase_add_test(tc_core, test_my_strcspn_some_matching_chars);

  tcase_add_test(tc_core, test_strerror);

  tcase_add_test(tc_core, test_my_strlen_empty_string);
  tcase_add_test(tc_core, test_my_strlen_nonempty_string);

  tcase_add_test(tc_core, test_my_strpbrk_found);
  tcase_add_test(tc_core, test_my_strpbrk_not_found);
  tcase_add_test(tc_core, test_my_strpbrk_null_str1);

  tcase_add_test(tc_core, test_my_strrchr_found);
  tcase_add_test(tc_core, test_my_strrchr_not_found);
  tcase_add_test(tc_core, test_my_strrchr_null_str);

  tcase_add_test(tc_core, test_my_strstr_empty_needle);
  tcase_add_test(tc_core, test_my_strstr_full_match);
  tcase_add_test(tc_core, test_my_strstr_partial_match);

  tcase_add_test(tc_core, test_my_strtok_basic);

  tcase_add_test(tc_core, test_my_strspn_matching);
  tcase_add_test(tc_core, test_my_strspn_no_matching);
  tcase_add_test(tc_core, test_my_strspn_null_str1);

  tcase_add_test(tc_core, test_my_memmove_non_overlap);
  tcase_add_test(tc_core, test_my_memmove_overlap_forward);
  tcase_add_test(tc_core, test_my_memmove_overlap_backward);
  tcase_add_test(tc_core, test_my_memmove_zero_size);

  tcase_add_test(tc_core, test_my_strcpy_non_empty_string);
  tcase_add_test(tc_core, test_my_strcpy_empty_string);
  ...
  tcase_add_test(tc_core, test_my_to_upper_null);
  tcase_add_test(tc_core, test_my_to_upper_v1);
  tcase_add_test(tc_core, test_my_to_upper_v2);
  tcase_add_test(tc_core, test_my_to_upper_v3);

  tcase_add_test(tc_core, test_my_to_lower_null);
  tcase_add_test(tc_core, test_my_to_lower_v1);
  tcase_add_test(tc_core, test_my_to_lower_v2);
  tcase_add_test(tc_core, test_my_to_lower_v3);

  tcase_add_test(tc_core, test_my_insert_null_null);
  tcase_add_test(tc_core, test_my_insert_v1);
  tcase_add_test(tc_core, test_my_insert_v2_out_of_range);
  tcase_add_test(tc_core, test_my_insert_v3_out_of_range);

  tcase_add_test(tc_core, test_my_trim_v1);
  tcase_add_test(tc_core, test_my_trim_v2);
  tcase_add_test(tc_core, test_my_trim_v3);
  tcase_add_test(tc_core, test_my_trim_v4);
  tcase_add_test(tc_core, test_my_trim_v5);
  tcase_add_test(tc_core, test_my_trim_v6);
