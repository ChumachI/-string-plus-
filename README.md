...
Цель my_string.a оформляет решение как статическую библиотеку
### Требуемые доработки
При одном из автоматических тестов valgrind показал conditional jump внутри sscanf ... определить условие и исправить